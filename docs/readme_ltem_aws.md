...
1. Ensure an _activated_ SIM card is inserted into the MG100 SIM slot.
...
If the MG100 is running firmware 3.0.0 or greater, firmware updates will be available in the mobile app or via the web UI.

#### FOTA Updates via BLE

After connecting to the MG100 click Device Firmware Upgrade.
